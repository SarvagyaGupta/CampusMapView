...
public class HW5TestDriver {
    ...
    protected final Map<String, MyGraph<String, String>> graphs = 
    		new HashMap<String, MyGraph<String, String>>();
    ...
    private void createGraph(String graphName) {
        graphs.put(graphName, new MyGraph<String, String>());
    ...
    private void addEdge(String graphName, String parentName, String childName,
            String edgeLabel) {
        graphs.get(graphName).addEdge(parentName, new DirectedEdge<String, String>(edgeLabel, childName));
    ...
    private void listChildren(String graphName, String parentName) {
        Set<DirectedEdge<String, String>> edges = graphs.get(graphName).getIncidentEdges(parentName);
